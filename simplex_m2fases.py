...
def obtener_fila_pivote(matriz,columna):
    ...
    division_previa = 1000000000000000000
...
variables = [ 'x2','x1','e2', 'x1', 'x2']

matriz = reduccion_gauss(matriz,variables[0])
matriz = reduccion_gauss(matriz,variables[1])
matriz = reduccion_gauss(matriz,variables[2])
matriz = reduccion_gauss(matriz,variables[3])
matriz = reduccion_gauss(matriz,variables[4])

#z = '-Z + 0.12x1 + 0.15x2 = 0'
z = [-1,0.12,0.0,0.15,0.0,0.0,0]
